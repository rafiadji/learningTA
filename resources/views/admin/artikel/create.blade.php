...
@section('content')
<div class="card">
	<form class="form-horizontal" action="{{ route('art.store') }}" method="POST" enctype="multipart/form-data">
	@csrf
	...
	<div class="card-body">
		...
		<div class="form-group row">
			...
			<div class="col-md-10">
				<textarea name="artikel" id="artikel" class="form-control editor"></textarea>
			</div>
		</div>
		<div class="form-group row">
